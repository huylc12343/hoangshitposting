...
import Merch_bg from "../assets/g9-min.png";
...
export default function Merch_HeroSection2() {
  ...
  const combosToDisplay = merchCombos.filter(
    (combo) => combo.isCombo === false
  );
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-white text-center mb-12 mt-24 w-full max-w-7xl">
        <h1 className="text-5xl sm:text-[80px] font-imbue mb-4">
          Tất cả sản phẩm
        </h1>
        {/* <p className='text-base'>Hình ảnh combo sẽ được cập nhật trong thời gian sớm nhất</p> */}
      </div>
