...
<div className="relative group w-full h-screen overflow-hidden">
  ...
  <div
    className="absolute inset-0 z-10 opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-opacity duration-700 ease-in-out"
    style={{
      backgroundImage: 'linear-gradient(to top, rgba(0,0,0,0.8), rgba(0,0,0,0))',
    }}
  />

<div className="absolute bottom-[20%] md:bottom-0 left-0 w-full z-20 flex justify-center opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-opacity duration-700 ease-in-out">
  <div className="w-full flex justify-center py-10">
    ...
    >
      ...
      Khám phá Fanpage của chúng mình
    </a>
  </div>
</div>
