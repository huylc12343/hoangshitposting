...
const AboutUs_HeroSection2 = () => {
  ...
  return (
    ...
    >
      {/* Tiêu đề giữa */}
      <h2 className="text-6xl font-bold font-imbue text-center mb-20 text-[#EEE1D8]">
        OFFLINE HỘI HOANG
      </h2>
      ...
      <div className="w-full max-w-6xl mb-12">
        <div className="grid grid-cols-1 md:grid-cols-10 gap-4 items-center">
          ...
          <div className="md:col-span-2 text-[#EEE1D8] text-6xl font-imbue font-extrabold flex justify-start md:items-center text-center md:text-left md:pr-8">
            TẦM NHÌN
          </div>

          {/* Cột phải */}
          <div className="md:col-span-8 font-Averta-CY text-[#EEE1D8] text-base text-justify leading-relaxed">
            <p>
