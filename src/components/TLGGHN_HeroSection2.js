  ...
  return (
    <section className="w-full text-white">
     ...
     <p className="text-lg mb-4 text-justify">
        Không gian FANART - nơi trưng bày các tác phẩm được gửi về từ người hâm mộ. Mỗi bức tranh, mỗi nét vẽ hay câu chữ đều mang theo một góc nhìn riêng, một cách cảm nhạc rất cá nhân. Dù là vẽ tay hay digital art, tất cả đều cùng nhau thắp lên cảm giác gắn kết đặc biệt giữa người nghe và ban nhạc: dịu dàng, lặng lẽ nhưng sâu sắc.
      </p>
      <img
        src={tlgg2}
        alt="Sự kiện Cá Hồi Hoang"
