...
import warningIcon from "../assets/timeout_popup.png";
import { useTheme } from "../contexts/Theme";

export default function TimeOut_Popup({ isOpen, onClose }) {
...
>
  ...
  <h2 className="text-3xl text-[#EEE1D8] font-bold text-center font-imbue">
    Hết thời gian đặt hàng
  </h2>
  {/* Nội dung */}
  <div className="text-center text-base text-gray-400 space-y-2 sm:p-8 sm:pb-4">
    <p>"Rồi thời gian cũng hết!"</p>
    <p>Nếu bạn đã chuyển khoản - Đừng lo!</p>
    <p>Hãy giữ minh chứng và thử lại sau nhé.</p>
    <p>Hoặc liên hệ fanpage Hoangshitposting để được hỗ trợ nha.</p>
  </div>
