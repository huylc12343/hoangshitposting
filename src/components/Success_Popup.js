  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-[#323232] text-black  rounded-xl shadow-2xl p-6 w-[90%] max-w-md space-y-4 relative">
        ...
        {/* Tiêu đề */}
        <h2 className="text-xl text-white font-bold text-center">ĐẶT HÀNG THÀNH CÔNG</h2>

        {/* Nội dung */}
        <p className="text-center text-gray-400">Cảm ơn bạn đã đồng hành cùng chúng mình. Email xác nhận sẽ được gửi đến bạn trong vòng 48h kể từ khi hoàn thành đơn hàng ạ. </p>
        <p className="text-center text-gray-400">Liên hệ fanpage: Hoangshitposting nếu có cần được hỗ trợ nha. </p>
