    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-[#323232] text-black  rounded-xl shadow-2xl p-6 w-[90%] max-w-md space-y-4 relative">
        ...
        <div className="flex flex-col gap-4 pt-4">
          ...
          >
            {isLoading ? "Đang xử lý đơn hàng ..." : "Xác nhận đảm bảo"}
          </button>
          {!isLoading && (
            <button
              onClick={onClose}
              className="w-full text-gray-400 py-4 rounded border border-gray-300 hover:bg-gray-300 text-sm font-semibold"
            >
              Kiểm tra lại
            </button>
          )}
